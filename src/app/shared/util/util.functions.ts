...
export const projects: ProjectInfo[] = [
  {productName: 'Serial30', name: 'serial30', image: 'project-list-1.webp', version: '1.2.1', link: 'https://serial30.ovh/about', description: `las aplicaciones que se desarrollan en ${environment.appName.toUpperCase()} se caracterizan por ser software de calidad, contar con funcionalidades que se adapten a tus necesidades y mantener un enfoque centrado en tus dispositivos.`},
